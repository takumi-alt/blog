        ...
        <>
             <div className="bg-regal-white">
                <div className="bg-regal-white flex justify-center h-12 md:w-4/5 mx-auto">
                    <Link to={`/blog/`}  className="text-regal-black hover:bg-gray-300 ... cursor-pointer h-12 font-mono font-black text-base sm:text-xl text-center border-l-2 border-gray-300 flex-1">home</Link>
                    ...
                    <Link to={'/blog/contact'} className="text-regal-black hover:bg-gray-300 ... cursor-pointer h-12 font-mono font-black text-base sm:text-xl text-center border-l-2 border-gray-300 flex-1">contact</Link>
