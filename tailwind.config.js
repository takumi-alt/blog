    ...
    extend: {
        ...
        keyframes: {
            ...
            round_animate1: {
                ...
                '75%': {borderRadius: '72% 28% 29% 71% / 37% 41% 59% 63% ', opacity:'0.9'},
                '100%': {borderRadius: '60% 40% 46% 54%/48% 66% 34% 52%', opacity:'0'},
            },
            round_animate2: {
                '0%': {borderRadius: '73% 27% 48% 52% / 41% 73% 27% 59%', opacity:'0'},
                '40%': {borderRadius: '52% 48% 38% 62% / 54% 46% 54% 46%', opacity:'0.3'},
                '75%': {borderRadius: '63% 37% 53% 47% / 77% 37% 63% 23%', opacity:'0.8'},
                '100%': {borderRadius: '73% 27% 48% 52% / 41% 73% 27% 59%', opacity:'0'},
            },
            round_animate3: {
                '0%': {borderRadius: '63% 37% 70% 30% / 38% 54% 46% 62%', opacity:'0'},
                '40%': {borderRadius: '48% 52% 24% 76% / 57% 30% 70% 43%', opacity:'0.5'},
                '75%': {borderRadius: '37% 63% 29% 71% / 73% 53% 47% 27%', opacity:'0.7'},
                '100%': {borderRadius: '63% 37% 70% 30% / 38% 54% 46% 62%', opacity:'0'},
            },
            round_animate4: {
                '0%': {borderRadius: '52% 48% 38% 62% / 54% 46% 54% 46%', opacity:'0'},
                '40%': {borderRadius: '48% 52% 24% 76% / 57% 30% 70% 43%', opacity:'0.6'},
